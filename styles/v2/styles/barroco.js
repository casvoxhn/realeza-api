...
Pure Rembrandt studio shadow — NO walls, NO curtains, NO objects, NO drapes.`;
  ...
  const paintingStyle = `
PAINTING STYLE:
17th century Baroque oil painting on canvas — museum quality.
Visible canvas texture and craquelure throughout.
Warm amber varnish patina. Chiaroscuro from upper left.
Impasto brushstrokes in background and fabric.
Photorealistic animal face and fur. Individual fur strands visible.
Deep luminous velvet shadows. Gold chain with metallic specular reflection.
